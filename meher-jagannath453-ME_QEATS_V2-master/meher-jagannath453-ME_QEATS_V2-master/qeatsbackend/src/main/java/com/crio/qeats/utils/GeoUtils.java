...
public class GeoUtils {
  ...
  public static double findDistanceInKm(double srcLatitude, double srcLongitude, double dstLatitude,
      double dstLongitude) {
   ...
   */
  private static double distance(double lat1, double lat2, double lon1, double lon2, double el1,
      double el2) {
